...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = '[COLOR orange][B]BEM-VINDOS AO LUMINART STUDIO[/B][/COLOR]'
###  DESCRIÇÃO DO ADDON ###############################################################
...
## MENU CONFIGURAÇÕES
menu_configuracoes = '[COLOR orange][B]AGRADECEMOS SUA VISITA[/B][/COLOR]'
thumb_icon_config = ''
...
url_b64_principal = 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL21lbGxvNTA2LzIuMS1FTlQuQ09OVC0wMDMtTkVXLUFERC9tYWluLzlDLUVOVC1HRVJWQVNJTy0wMzIuMDAzLU1UWA=='
...
def check_addon():
    try:
        ...
        if exists == True:
                    ...
                    if addon_id == 'plugin.video.elementum' and elementum == 'false':
                        ...
                        if os.path.exists(existe)==False:
                            ...
                            if addon_id == 'plugin.video.elementum':
                                xbmcgui.Dialog().ok('[B][COLOR orange]AVISO[/COLOR][/B]','FECHE O KODI E ABRA NOVAMENTE PARA ATIVAR O ELEMENTUM')
                        else:
                            pass
            ...
            fcheck.write('1')
            fcheck.close()
            xbmcgui.Dialog().ok('[B][COLOR orange]AVISO[/COLOR][/B]','FECHE O KODI E ABRA NOVAMENTE PARA VERIFICAR COMPLEMENTOS')
    except:
        pass
